...
// 메뉴에 사용할 문자열 배열
// 전역변수로써 작용하지만, 이 파일에서만 접근할 수 있도록 static 선언
// (여러 메뉴의 상단에 띄울 메뉴 변수 이름을 각기 다르게 설정하지 않기 위해)
static char *choices[] = {
    "Manage Directory",
    "About Git",
    "Exit",
...
void show_main_menu()
{
    ...
    print_in_middle(my_menu_win, title_y, title_x, title_width, "Git Helper", COLOR_PAIR(1));
